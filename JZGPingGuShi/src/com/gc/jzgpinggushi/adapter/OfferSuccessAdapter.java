 ...
 * File Name:OfferSuccessAdapter.java
 * Package Name:com.gc.jzgpinggushi.adapter
 * Date:2014-10-8上午9:46:25
...
/**
 * ClassName:OfferSuccessAdapter <br/>
 * Function: 出价成功列表适配器. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2014-10-8 上午9:46:25 <br/>
 * 
 * @author 汪渝栋
 * @version
 * @since JDK 1.6
 * @see
 */
public class OfferSuccessAdapter extends BaseAdapter
{
	private LayoutInflater inflater;

	private List<OfferSuccess> list;
	...
	public OfferSuccessAdapter(Context context, List<OfferSuccess> list)
	{
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			convertView = inflater.inflate(R.layout.success_list_content, null);
